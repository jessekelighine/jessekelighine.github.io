...
- `2024-04-16` **最終決定**
	- 美國時間（取決於學校的所在地，我是看美東時間）是 `2024-04-15` 結束之前要決定，
...
- 會申請德國碩士的原因是我會一些德語，而且德國有很好的移民條件，只要畢業找得到工作就有永久居留權。
...
像是我考 GRE 的時候其實有點太隨便（沒在背單字），語文部分才沒有達到我心中的目標。
...
Quantitative 的部分其實是滿簡單的，
基本上只要腦袋清楚就可以了。
所以 **Quantitative 沒有滿分就是亞洲之恥**。 [^disgrace]
至於 Quantitative 的準備方式，
就是練習個兩三次模擬試題就可以了。

[^disgrace]:
  Aka: Disgrace of the Race.
  但是認真說這句話不是說笑而已：
  因為他們都知道在亞洲 Quantitative 滿分是家常便飯，
  所以如果沒有滿分的話真的會有點危險。
