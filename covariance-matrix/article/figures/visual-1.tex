...
\begin{tikzpicture}[scale=1.5,thick,line cap=round]
	...
	\draw[draw=none,rotate=50,fill=myblue!45] (0,0) ellipse (0.8cm and 0.9cm);
	\draw[draw=none,rotate=30,fill=myred!45]  (0,0) ellipse (0.6cm and 0.4cm);
	...
	\node[jiao] at (0,0) {};
	\node[label=below:{\textsc{Case 1}}] at (0,-1) {};
\end{tikzpicture}
